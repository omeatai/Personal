...
if (process.env.NODE_ENV === "development") {
  ...
  const PRIVATE_KEY = process.env.DEV_JWT_PRIVATE_KEY;
  const JWT_EXPIRY = process.env.DEV_JWT_EXPIRY;
  const JWT_HTTPS = process.env.DEV_JWT_HTTPS;
  const SESSION_SECRET = process.env.DEV_SESSION_SECRET;
  const EMAIL_ADDRESS = process.env.DEV_EMAIL_ADDRESS;
  const EMAIL_PASSWORD = process.env.DEV_EMAIL_PASSWORD;
...
if (process.env.NODE_ENV === "production") {
  ...
  const JWT_HTTPS = process.env.PROD_JWT_HTTPS;
