...
- **Next task:** `1.5` — JS Let (improvement pass; user requested range JS Introduction → JS Strings).
- **Last completed:** `1.4` JS Variables — rewritten to per-example standard (declare/undefined, identifiers, data types & multiple, assignment & arithmetic).
...
- [ ] `1.5` JS Let — `js_let.asp` (exists — improve)
- [ ] `1.6` JS Const — `js_const.asp` (exists — improve)
- [ ] `1.7` JS Types — `js_types.asp` (exists — improve)

### S2 — Operators

- [ ] `2.1` JS Operators — `js_operators.asp` (exists — improve)
...
- [ ] `7.1` JS Functions — `js_functions.asp` (new)
- [ ] `7.2` Function Intro — `js_function_intro.asp` (new)
- [ ] `7.3` Function Invocation — `js_function_invocation.asp` (new)
...
- [ ] `7.8` Function Arrow — `js_arrow_function.asp` (new)
- [ ] `7.9` Function Quiz — `js_function_quiz.asp` (new)
- [ ] `7.10` JS Timers — `js_timers.asp` (new)

### S8 — Objects

- [ ] `8.1` JS Objects — `js_objects.asp` (new)
- [ ] `8.2` Object Intro — `js_object_intro.asp` (new)
- [ ] `8.3` Object Properties — `js_object_properties.asp` (new)
- [ ] `8.4` Object Methods — `js_object_methods.asp` (new)
...
- [ ] `9.5` JS Strict Mode — `js_strict.asp` (new)

### S10 — Dates

- [ ] `10.1` JS Dates — `js_dates.asp` (new)
- [ ] `10.2` JS Date Formats — `js_date_formats.asp` (new)
- [ ] `10.3` JS Date Get — `js_date_methods.asp` (new)
...
- [ ] `11.8` JS Array const — `js_array_const.asp` (new)
...
- [ ] `12.5` JS Set Reference — `js_set_reference.asp` (new)

### S13 — Maps

- [ ] `13.1` JS Maps — `js_maps.asp` (new)
- [ ] `13.2` JS Map Methods — `js_map_methods.asp` (new)
- [ ] `13.3` JS Map WeakMap — `js_maps_weak.asp` (new)
- [ ] `13.4` JS Map Reference — `js_map_reference.asp` (new)

### S14 — Iterations

- [ ] `14.1` JS Iterations — `js_looping.asp` (new)
- [ ] `14.2` JS Iterables — `js_iterables.asp` (new)
...
- [ ] `16.1` JS RegExp — `js_regexp.asp` (new)
- [ ] `16.2` JS RegExp Flags — `js_regexp_flags.asp` (new)
- [ ] `16.3` JS RegExp Classes — `js_regexp_characters.asp` (new)
- [ ] `16.4` JS RegExp Metachars — `js_regexp_meta_characters.asp` (new)
- [ ] `16.5` JS RegExp Assertions — `js_regexp_assertions.asp` (new)
...
- [ ] `17.1` JS Data Types — `js_datatypes.asp` (new)
- [ ] `17.2` JS Primitive Data — `js_datatypes_primitives.asp` (new)
