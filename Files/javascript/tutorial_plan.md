...
`Files/javascript/tutorial.md` (through **JS Date Methods**) and
`Files/javascript/tutorial2.md` (**JS Arrays** onward), following the rule
...
2. Do the page end-to-end per the rule: **read → rebuild every example in the sandbox → run → snap code + result → append one accordion** to `tutorial.md` (through JS Date Methods) or `tutorial2.md` (JS Arrays onward). The accordion **Introduction** must list **every** Example title (all N of them).
...
- **Last completed:** `26.4` HTML First CSS.
...
- [x] `20.1` JS Style Guide — `js_conventions.asp` (new)
- [x] `20.2` JS Best Practices — `js_best_practices.asp` (new)
- [x] `20.3` JS Mistakes — `js_mistakes.asp` (new)
- [x] `20.4` JS Performance — `js_performance.asp` (new)
...
- [x] `22.5` JS Form Validation (Project) — `js_project_form_validation.asp` (new)
...
- [x] `24.1` HTML DOM — `js_htmldom.asp` (new)
- [x] `24.2` HTML DOM API — `js_htmldom_methods.asp` (new)
...
- [x] `24.7` DOM Animations — `js_htmldom_animate.asp` (new)
- [x] `24.8` Document Reference — `js_htmldom_document.asp` (new)
- [x] `24.9` Element Reference — `js_htmldom_element_reference.asp` (new)

### S25 — JS HTML Events

- [x] `25.1` Intro to Events — `js_events.asp` (new)
- [x] `25.2` Mouse Events — `js_events_mouse.asp` (new)
- [x] `25.3` Keyboard Events — `js_events_keyboard.asp` (new)
...
- [x] `26.4` HTML First CSS — `js_htmlfirst_css.asp` (new)
